    ...
    qualityGateReport: z.object({
        ...
        checks: z.object({
            ...
            originality: z.object({
                ...
                innovationFindings: z.array(z.string()),
                reasoning: z.string(),
            }),
        }),
        summary: z.object({
...
export const QualityGate7OutputSchema = z.object({
    qualityGateReport: z.object({
        ...
        checks: z.object({
            ...
            highSignalDetails: z.object({
                score: z.number(),
                reasoning: z.string(),
                preservedHighlights: z.array(z.string()),
            }),
            inventiveCinematography: z.object({
                score: z.number(),
                reasoning: z.string(),
                inventiveShotCount: z.number(),
            }),
            microAnimationPlans: z.object({
                score: z.number(),
                reasoning: z.string(),
                priorityMoments: z.array(z.string()),
            }),
            departmentSpecificity: z.object({
                passed: z.boolean(),
                reasoning: z.string(),
                genericDepartments: z.array(z.string()),
            }),
        }),
        summary: z.object({
            overallScore: z.number(),
